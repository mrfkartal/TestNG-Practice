...
public class C07_SoftAssert extends TestBase {
    ...
    public void test01() {
        ...
        /*
        temelde  junit---testNG farki
        1-before ve after methodlari daha fazla
        2-priorty(oncelik) (Test siralamasi yapilabilir)
        3-dependson(bir methoda bagli olarak calisir-calisma sirasina karismaz)
        4-raporlama
         */
